...
class ContinuousA2C(tf.keras.Model):
    def __init__(self, action_size):
        ...
        #self.actor_fc0 = Dense(64, activation='relu',kernel_initializer=RandomUniform(-1e-3, 1e-3))
        self.actor_fc1 = Dense(32, activation='relu',kernel_initializer=RandomUniform(-1e-3, 1e-3))
        self.actor_mu = Dense(action_size,
                              kernel_initializer=RandomUniform(-1e-3, 1e-3))
        self.actor_sigma = Dense(action_size, activation='sigmoid',
                                 kernel_initializer=RandomUniform(-1e-3, 1e-3))

        self.critic_fc1 = Dense(32, activation='relu',kernel_initializer=RandomUniform(-1e-3, 1e-3))
        self.critic_fc2 = Dense(16, activation='tanh',kernel_initializer=RandomUniform(-1e-3, 1e-3))
